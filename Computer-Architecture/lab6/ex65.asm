...
; asemblacja (MASM 4.0): masm ex65.asm,,,;
; konsolidacja (LINK 3.60): link ex65.obj;
.386
...
linia PROC
    ...
    add cs:licznik, 5        ; licznik do sterowania "pionowym krokiem"
    cmp cs:licznik, 8        ; czy osiągnięto próg (8 jednostek)
    jl bez_zmiany            ; jeśli nie, nie zmieniaj wiersza

    ; przesunięcie o 1 piksel w dół (pion) i reset licznika
    add bx, word PTR cs:przyrost             ; przejście do następnego wiersza
    sub cs:licznik, 8        ; zresetowanie licznika o 8

bez_zmiany:
    ; przesunięcie o 1 piksel w prawo
    inc bx                   ; przesunięcie w poziomie
...
dalej:
    ...
    ; zmienne procedury
    kolor db 13 ; bieżący numer koloru
    licznik dw 0
