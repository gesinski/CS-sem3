...
int main(int argc, char *argv[])
{
  ...
  unsigned int color = 256*200*255 + 256*140 + 20;
    ...
    switch(event.type)
    {
      case Expose:
        if (event.xexpose.count == 0)
        {
          ...
          XPoint Fpoints[12] = {{FOrigin.x, FOrigin.y}, {20, 0}, {0, 20},
                              {20, 0}, {0, -20}, {20, 0}, {0, 60}, {-20, 0}, {0,-20}, {-20,0},
                              {0, 20}, {-20, 0}};
          
          XFillPolygon(display, window, gc, Fpoints, 12, Nonconvex, CoordModePrevious);
